...
class ProductController {
  ...
  Future<void> updatePrice(int newPrice, String productName, String category) async {
    print('Calling updateStartPrice in ProductHttpService for product: $productName with new price: $newPrice');
    
    // Ensure products are fetched and populated
